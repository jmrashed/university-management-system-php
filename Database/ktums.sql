...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 22, 2016 at 03:08 PM
...
INSERT INTO `message` (`id`, `senderid`, `receiverid`, `title`, `message`, `isread`, `receivertype`, `datetime`) VALUES
...
INSERT INTO `notice` (`id`, `adminid`, `title`, `notice`, `datetime`) VALUES
(1, 1, 'Next Presentation date has been fixed', 'The Chairnman sir has been declared Next Presentation date has been fixed', '2016-08-22 17:52:25');
...
CREATE TABLE IF NOT EXISTS `onlinequestion` (
`id` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `onlinetest` (
`id` int(11) NOT NULL,
...
(26, 5, 'English', 2, 0, 0, 5, 0, 0, 0, 0, 0, 0, 0, '2016-08-20 02:04:46'),
(27, 5, 'Chemistry', 2, 0, 0, 5, 0, 0, 0, 0, 0, 0, 0, '2016-08-20 02:04:46'),
...
CREATE TABLE IF NOT EXISTS `systm` (
`id` int(11) NOT NULL,
...
--
ALTER TABLE `student`
 ADD PRIMARY KEY (`id`), ADD UNIQUE KEY `studentid` (`studentid`);
